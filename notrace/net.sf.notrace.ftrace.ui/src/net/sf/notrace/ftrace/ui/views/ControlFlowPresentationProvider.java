...
import net.sf.notrace.ftrace.analysis.FtraceAnalysisModule;
import net.sf.notrace.ftrace.state.Attributes;
import net.sf.notrace.ftrace.state.StateValues;
import net.sf.notrace.ftrace.ui.FtracePlugin;
import net.sf.notrace.ftrace.ui.Messages;
